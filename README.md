...
Блог для любителей котиков! Можно добавлять фото, достижения для Ваших пушистых повелителей, а также рассказать всем, как зовут Его/Её, какого они цвета и когда родились :)
...
```
git clone git@github.com:KhitK0101/infra_sprint1.git
```
...
- DevOps: Хитяев Кирилл
- Ревьюер ночных страданий: Андрей Дубинчик